...
urlpatterns = [
    ...
    path('packagings/', views.PackagingListCreateView.as_view(), name='packaging-list-create'),
    path('packagings/<int:pk>/', views.PackagingDetailView.as_view(), name='packaging-detail'),
