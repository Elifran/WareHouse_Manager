...
const PointOfSale = () => {
  ...
  const fetchProducts = async (filterParams = {}) => {
    try {
      ...
      // If categories are not loaded yet, show all products
  ...
  const fetchCategories = async () => {
    try {
      ...
      // Categories error - continue without categories
    }
  };
  ...
  const fetchStockAvailability = async (productId) => {
    try {
      ...
      // Stock availability error - continue without stock info
    }
  };
  ...
  const autoPrintReceipt = async (saleNumber, saleData, saleStatus = 'completed') => {
    try {
      ...
      // Auto-print error - not critical, continue silently
    }
  };
